  ...
  return (
    <div>
      <div className="w-full relative lg:hidden">
        ...
        {isOpen && (
          <div className="fixed flex flex-col py-10 border-2 bg-ugray-0 shadow-lg rounded-lg items-center justify-center top-0 left-0 right-0 z-10">
                ...
                <div key={item.id}>
                  <Link
                    ...
                    className={`flex gap-2 items-center p-1  ${
                      pathName === item.path &&
                      "bg-ugray-950 text-ugray-50 border rounded-md p- "
                    }`}
                  >
